...
export default {
  ...
  methods: {
    ...
    getParentSize () {
      if (this.parent) {
        let pa = document.getElementsByClassName('dev')[0]
        //const style = window.getComputedStyle(pa, null)
        const style = window.getComputedStyle(this.$el.parentNode, null)
        console.log(this.$el,this.$el.parentNode,'this.$el.parentNode')
        return [
    ...
    calcDragLimits () {
      console.log(this.parentHeight,this.height, this.top,this.grid,'wawa--')
      return {
    ...
    calcResizeLimits () {
      ...
      console.log(this.top,'this.topthis.top')
      const top = this.top
      ...
      if (this.parent) {
        ...
        console.log(top,Math.floor((height - minH) / gridY) * gridY,'Math.floor((height - minH) / gridY) * gridY')
      ...
      console.log(limits,'limitslimits')
      return limits
    },
    move (e) {
      if (this.resizing) {
