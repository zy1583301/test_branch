 ...
 *-------------------------------------------------------------------------------------*/
// import { getSourceList, getTables} from '@/api/data'
// let userName = JSON.parse(sessionStorage.getItem('userInfo')).username
const makeKeywordsProposals = () => [
  {
    label: "ADD",
...
const makeDbsProposals = async () => {
  return new Promise((resolve, reject) => {
    // getSourceList(
    //   {
    //     params: {engineName: 'presto', loginName: userName},
    //     hideLoading: true
    //   }).then(res => {
    //   let  dbObj = res.data.database
    //   const dbs = Array.prototype.concat.apply([],Object.keys(dbObj).map(item => {
    //     return dbObj[item].map(ite => {
    //       return{
    //         label:ite.dbName,
    //         documentation:"库名字段",
    //         insertText:ite.dbName,
    //         detail:ite.dsName,
    //         id:ite.id,
    //         engineID:ite.engineId
    //       }
    //     })
    //   }))
    //   resolve(dbs);
  ...
  // let res = await serve({
  //   url:'getDataSourceListByEngineId',
  //   method:'get',
  //   params:{
  //     engineName:"presto"
  //   }
...
const makeTablesProposals = async (engineID,dataSourceId) => {
  return new Promise((resolve,reject) => {
    // if(!engineID || !dataSourceId) {
    //   resolve([])
    //   return
    // }
    // getTables({
    //   params: {engineID: engineID, dataSourceId: dataSourceId, loginName: userName},
    //   hideLoading: true
    // }).then(res => {
    //   let data = []
    //   if (res.data) {
  ...
  // let res = await serve({
  //   url:'getTableMetaByDataSourceId',
  //   method:'get',
  //   params:{
  //     engineID:engineID,
...
export { makeTablesProposals, makeDbsProposals, makeColumnsProposals, makeKeywordsProposals };
